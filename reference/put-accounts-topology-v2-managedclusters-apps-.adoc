...
summary: Modificar um aplicativo para um cluster gerenciado 
---
= Modificar um aplicativo para um cluster gerenciado
:allow-uri-read: 
...
| forceUpdate | string | cabeçalho | Falso  a| 
Sinalizador que permite sobrescritas destrutivas. Inclua-o apenas ao solicitar uma restauração no local (IPR).
