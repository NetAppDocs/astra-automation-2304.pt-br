...
summary: Liste todos os recursos AppMirror 
---
...
| itens | array[Qualquer um de: link:#appMirror_1_0_get_response_body["appMirror_1.0_get_response_body"], array[]] | Verdadeiro  a| 
