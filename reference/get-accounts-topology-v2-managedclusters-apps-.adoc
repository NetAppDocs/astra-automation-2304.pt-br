...
summary: Recuperar um aplicativo para um cluster gerenciado 
---
= Recuperar um aplicativo para um cluster gerenciado
:allow-uri-read: 


[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/accounts/{account_id}/topology/v2/managedClusters/{managedCluster_id}/apps/{app_id}`#
