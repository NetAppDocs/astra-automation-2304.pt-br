...
summary: Recuperar um recurso AppMirror para um aplicativo 
---
= Recuperar um recurso AppMirror para um aplicativo
:allow-uri-read: 
...
Retorna o recurso da API AppMirror armazenado no corpo da resposta JSON.
