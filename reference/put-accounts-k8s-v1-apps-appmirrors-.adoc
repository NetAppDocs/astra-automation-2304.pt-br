...
summary: Modificar um recurso AppMirror para um aplicativo 
---
= Modificar um recurso AppMirror para um aplicativo
:allow-uri-read: 
...
* Diversos efeitos colaterais com base em desiredState.
...
| ID do cluster de destino | string | Falso  a| 
