...
summary: Recuperar um Snapshot do aplicativo 
---
= Recuperar um Snapshot do aplicativo
:allow-uri-read: 
...
Retorna o recurso da API Application Snapshot armazenado no corpo da resposta JSON.
