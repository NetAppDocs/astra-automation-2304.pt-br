...
summary: Recuperar um volume para um backend de armazenamento 
---
= Recuperar um volume para um backend de armazenamento
:allow-uri-read: 
...
ID do recurso storageBackend que o contém
