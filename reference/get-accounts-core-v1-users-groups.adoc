...
summary: Listar grupos para um usuário 
---
= Listar grupos para um usuário
:allow-uri-read: 
...
| itens | array[Qualquer um de: link:#group_1_0_get_response_body["group_1.0_get_response_body"], array[]] | Verdadeiro  a| 
