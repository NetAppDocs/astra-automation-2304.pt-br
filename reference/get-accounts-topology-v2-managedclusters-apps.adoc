...
summary: Liste os aplicativos para um cluster gerenciado 
---
= Liste os aplicativos para um cluster gerenciado
:allow-uri-read: 
...
| itens | array[Qualquer um de: link:#app_2_2_get_response_body["app_2.2_get_response_body"], array[]] | Verdadeiro  a| 
