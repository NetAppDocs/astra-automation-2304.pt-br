...
summary: Modificar um cluster para a nuvem 
---
= Modificar um cluster para a nuvem
:allow-uri-read: 
...
* Se o cluster estiver em um estado gerenciado, uma atualização do credentialID eventualmente acionará outra tentativa de coletar o cluster.
